...
**[在线体验](https://merchantmind-ai-growth-zhangzi.nk9wq6b642.chatgpt.site/)** · [90 秒演示](#90-秒演示脚本) · [项目面试讲解](docs/interview-guide.md)

## 项目亮点

- **完整业务闭环：** 从 CSV 数据上传、趋势与异常定位，到 P1—P3 行动、进度管理、复盘和方案导出。
- **可信 AI：** 核心建议由可解释规则驱动；OpenAI 问答为可选增强，服务不可用时自动降级。
- **工程质量：** 数据字段校验、浏览器本地持久化、自动化测试、构建检查和公开在线体验齐全。
...
更完整的项目讲解与面试追问答案见 [项目面试讲解稿](docs/interview-guide.md)。
